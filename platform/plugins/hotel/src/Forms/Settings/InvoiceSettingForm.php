...
class InvoiceSettingForm extends SettingForm
{
    public function setup(): void
    {
        ...
        $this
            ->setSectionTitle(trans('plugins/hotel::settings.invoice.title'))
            ->setSectionDescription(trans('plugins/hotel::settings.invoice.description'))
            ...
            ->add('hotel_company_logo_for_invoicing', 'mediaImage', [
