...
use Botble\Hotel\Http\Requests\Fronts\RoomListRequest;
...
{
    public function getRooms(RoomListRequest $request, RoomInterface $roomRepository, BaseHttpResponse $response)
    {
