                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 order-1">
                            <div class="widget site-info-widget mb-50">
                                ...
                                <p style="font-size: 20px;text-align: justify;font-weight: 600;">{{ theme_option('about-us') }}</p>
                            ...
                            <div class="widget contact-widget mb-50">
                                ...
                                <div class="contact-lists">
                                    <div class="contact-box">
                                        ...
                                        <div class="desc" style="font-size: 18px;font-weight: 700;">
                                    ...
                                    <div class="contact-box">
                                        ...
                                        <div class="desc" style="font-size: 18px;font-weight: 700;text-align:justify;">
                                            <h6 class="title">{{ __('Office Address') }}</h6>
                                            {{ theme_option('address') }} 800001
                                        </div>
                                    </div>
                                </div>
                            </div>
